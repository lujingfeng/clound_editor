...
fis.match('*.less', {
  ...
  parser: ['babel'],
  rExt: 'js'
}).match("**/({jquery,react,reflux,reactRouter,iscrollLite}).js", {
  id: "$1",
  moduleId: "$1"
...
development.match('*.{jsx,js,less,css,png,jpg,jpeg,svg,eot,ttf,woff,swf}', {
  domain: LOCAL_HOST_DOMAIN,
  deploy: fis.plugin('local-deliver', {
    to: OUTPUT_DIR
  })
...
production.match('*.{jsx,js,less,css,png,jpg,jpeg,svg,eot,ttf,woff,swf}', {
